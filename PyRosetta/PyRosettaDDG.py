...
import time
import xlwt
init('-use_input_sc -ignore_unrecognized_res -ignore_zero_occupancy false -relax:default_repeats 5 -ex1 -ex2 -fa_max_dis 9.0 -flip_HNQ')
print('\n')
