...
The file SaCas9_ddG_Binding_inhouse.csv contains the in-house empirical fitness data for SaCas9 and also the UniDesign ddG_Binding. The values are Empirical results, AB/C, AB/CD results respectively (From left to right)
